...
- ✅ Создаст данные при первом запуске
- ✅ Запустит дашборд автоматически
...
# Способ 2: Ручная установка основных пакетов
...
**macOS/Linux:**
```bash
# Решение 1: Запустите автоматический установщик
python3 start.py

# Решение 2: Проверьте интернет-соединение и повторите
python3 simple_dashboard.py

# Решение 3: Установите зависимости вручную
pip3 install --upgrade flask pandas requests beautifulsoup4
```
